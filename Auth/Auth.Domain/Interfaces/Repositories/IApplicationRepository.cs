...
public interface IApplicationRepository
{
    ...
    /// </summary>
    Task<IReadOnlyList<Auth.Domain.Entities.Role>> GetRolesAsync(Guid applicationId, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets permissions for an application.
    /// </summary>
    Task<IReadOnlyList<Auth.Domain.Entities.Permission>> GetPermissionsAsync(Guid applicationId, CancellationToken cancellationToken = default);
}
