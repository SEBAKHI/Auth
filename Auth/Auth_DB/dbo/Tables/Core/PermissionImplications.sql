...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_PermissionImplications_Id] DEFAULT NEWID(),
    [PermissionId] UNIQUEIDENTIFIER NOT NULL,
    [ImpliedPermissionId] UNIQUEIDENTIFIER NOT NULL,
    [CreatedAt] DATETIME2 NOT NULL CONSTRAINT [DF_PermissionImplications_CreatedAt] DEFAULT GETUTCDATE(),
