/*
  ...
  (https://astoom.com/branding/sebakhi-email-logo.png). The renderer now
...
DECLARE @OldLogo NVARCHAR(MAX) = N'<tr><td class="logo"><img src="https://astoom.com/branding/sebakhi-email-logo.png" width="200" alt="{{ Platform.Name }}"></td></tr>';
