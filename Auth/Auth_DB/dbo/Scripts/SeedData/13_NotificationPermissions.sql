...
BEGIN
    ...
    VALUES (N'20000000-0000-0000-0000-0000000000B0', N'notification-templates:*', N'All Notification Template Permissions', N'Full access to notification template management', @AuthAppId, N'20000000-0000-0000-0000-000000000002', 2, 1, 1, GETUTCDATE(), @SystemUserId);
...
BEGIN
    INSERT INTO [dbo].[Permissions] ([Id], [Code], [Name], [Description], [ApplicationId], [ParentId], [Level], [IsWildcard], [IsActive], [CreatedAt], [CreatedBy])
    VALUES (N'20000000-0000-0000-0000-0000000000B1', N'notification-templates:read', N'Read Notification Templates', N'View notification templates, versions, translations, and types', @AuthAppId, N'20000000-0000-0000-0000-0000000000B0', 3, 0, 1, GETUTCDATE(), @SystemUserId);
...
BEGIN
    INSERT INTO [dbo].[Permissions] ([Id], [Code], [Name], [Description], [ApplicationId], [ParentId], [Level], [IsWildcard], [IsActive], [CreatedAt], [CreatedBy])
    VALUES (N'20000000-0000-0000-0000-0000000000B2', N'notification-templates:manage', N'Manage Notification Templates', N'Create, edit, preview, test-send, and delete notification templates and drafts', @AuthAppId, N'20000000-0000-0000-0000-0000000000B0', 3, 0, 1, GETUTCDATE(), @SystemUserId);
...
BEGIN
    INSERT INTO [dbo].[Permissions] ([Id], [Code], [Name], [Description], [ApplicationId], [ParentId], [Level], [IsWildcard], [IsActive], [CreatedAt], [CreatedBy])
    VALUES (N'20000000-0000-0000-0000-0000000000B3', N'notification-templates:publish', N'Publish Notification Templates', N'Publish, unpublish, and roll back notification template versions', @AuthAppId, N'20000000-0000-0000-0000-0000000000B0', 3, 0, 1, GETUTCDATE(), @SystemUserId);
...
BEGIN
    INSERT INTO [dbo].[Permissions] ([Id], [Code], [Name], [Description], [ApplicationId], [ParentId], [Level], [IsWildcard], [IsActive], [CreatedAt], [CreatedBy])
    VALUES (N'20000000-0000-0000-0000-0000000000B4', N'notification-layouts:manage', N'Manage Notification Layouts', N'Edit, preview, and publish notification layouts (shared visual identity)', @AuthAppId, N'20000000-0000-0000-0000-000000000002', 3, 0, 1, GETUTCDATE(), @SystemUserId);
