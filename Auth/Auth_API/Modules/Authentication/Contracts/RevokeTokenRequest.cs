...
/// <summary>
/// Request to revoke an access or refresh token (RFC 7009).
/// </summary>
/// <remarks>
/// Form-encoded, not JSON, and snake_case — because RFC 7009 says so, and the
...
public class RevokeTokenRequest
{
    ...
    /// </summary>
    /// <remarks>
    /// An unknown value is ignored rather than refused: RFC 7009 makes the
