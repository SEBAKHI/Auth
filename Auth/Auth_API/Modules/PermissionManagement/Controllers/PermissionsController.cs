...
public class PermissionsController : ApiController
{
    ...
    /// </summary>
    [HttpGet]
    [RequirePermission(PermissionCodes.Permissions.Read)]
    ...
    /// </summary>
    [HttpPost]
    [RequirePermission(PermissionCodes.Permissions.Create)]
    ...
    /// </summary>
    [HttpPut("{id:guid}")]
    [RequirePermission(PermissionCodes.Permissions.Update)]
    [ProducesResponseType(typeof(PermissionDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
    ...
    /// </summary>
    [HttpDelete("{id:guid}")]
    [RequirePermission(PermissionCodes.Permissions.Delete)]
    ...
    [RequirePermission(PermissionCodes.Permissions.Manage)]
