...
public sealed class GatewayRuntimeSettingsProvider
{
    ...
    private static GatewayRateLimits ReadRateLimits(IConfiguration configuration) => new(
        ...
        RegisterPermitLimit: configuration.GetValue("RateLimiting:RegisterPermitLimit", 200),
        RegisterWindowSeconds: configuration.GetValue("RateLimiting:RegisterWindowSeconds", 60),
