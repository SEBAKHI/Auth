...
export function getRendererGlobals(t: (key: string) => string): TemplateVariable[] {
  return [
    ...
    { name: "Platform.EmailLogoUrl", description: t("notifications.globalVarPlatformEmailLogoUrl"), example: "https://auth.example.com/uploads/images/platform-email-light.png" },
    { name: "Platform.EmailLogoDarkUrl", description: t("notifications.globalVarPlatformEmailLogoDarkUrl"), example: "https://auth.example.com/uploads/images/platform-email-dark.png" },
