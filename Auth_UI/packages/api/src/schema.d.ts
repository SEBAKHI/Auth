...
export interface paths {
    ...
    "/api/v1/Roles/{id}/permissions": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["GrantRolePermissionRequest"];
                    "text/json": components["schemas"]["GrantRolePermissionRequest"];
                    "application/*+json": components["schemas"]["GrantRolePermissionRequest"];
                };
            };
            responses: {
    ...
    "/api/v1/Organizations/{id}/applications/available": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["AvailableApplicationDto"][];
                        "application/json": components["schemas"]["AvailableApplicationDto"][];
                        "text/json": components["schemas"]["AvailableApplicationDto"][];
                    };
                };
                /** @description Unauthorized */
                401: {
    ...
    "/api/v1/dashboard/credential-stats": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["CredentialStatsDto"];
                        "application/json": components["schemas"]["CredentialStatsDto"];
                        "text/json": components["schemas"]["CredentialStatsDto"];
                    };
                };
                /** @description Bad Request */
                400: {
    ...
    "/api/v1/Applications/{id}/access": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["ApplicationAccessGrantDto"][];
                        "application/json": components["schemas"]["ApplicationAccessGrantDto"][];
                        "text/json": components["schemas"]["ApplicationAccessGrantDto"][];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["GrantApplicationAccessRequest"];
                    "text/json": components["schemas"]["GrantApplicationAccessRequest"];
                    "application/*+json": components["schemas"]["GrantApplicationAccessRequest"];
                };
            };
            responses: {
    ...
    "/api/v1/admin/Secrets/smtp-password": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/Secrets/connection-string": {
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["SetConnectionStringRequest"];
                    "text/json": components["schemas"]["SetConnectionStringRequest"];
                    "application/*+json": components["schemas"]["SetConnectionStringRequest"];
                };
            };
            responses: {
...
export interface components {
    schemas: {
        ...
        CredentialExpiryBucketDto: {
            /** Format: int32 */
            expiringCount?: number | string;
            /** Format: date-time */
            soonestExpiresAt?: null | string;
            /** Format: int32 */
        ...
        CredentialStatsDto: {
            /** Format: int32 */
            horizonDays?: number | string;
            apiKeys?: null | components["schemas"]["CredentialExpiryBucketDto"];
            webhookKeys?: null | components["schemas"]["CredentialExpiryBucketDto"];
        };
        DailyCountDto: {
            /** Format: date-time */
            date?: string;
