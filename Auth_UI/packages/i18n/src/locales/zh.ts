...
export const zh: TranslationResources = {
  ...
  fields: {
    acceptedAt: "接受时间",
    acceptedByUser: "接受人",
    acceptedByUserId: "接受人",
    acceptedByUserName: "接受人",
    accessMode: "访问模式",
    accessSource: "访问途径",
    action: "操作",
    actionType: "操作类型",
    ...
    deletedAt: "删除时间",
    description: "描述",
    disclosureOutOfDate: "告知已过时",
    displayName: "显示名称",
    draftContent: "草稿内容",
    draftStringsJson: "草稿文本",
    draftVersionNumber: "草稿版本",
    effectiveDateUtc: "生效日期",
    email: "邮箱",
    ...
    hasDraft: "有草稿",
    hasPassword: "有密码",
    hasUnpublishedChanges: "有未发布的更改",
    id: "ID",
    invitedBy: "邀请人",
    invitedByEmail: "邀请人邮箱",
    invitedByName: "邀请人",
    ipAddress: "IP 地址",
    isActive: "活跃",
    isDeleted: "已删除",
    ...
    newValues: "新值",
    nextAttemptAt: "下次尝试",
    notificationTypeCode: "类型代码",
    notificationTypeId: "类型 ID",
    notifiedAtUtc: "通知时间",
    notifiedCount: "收件人数",
    oldValues: "旧值",
    organization: "组织",
    organizationId: "组织 ID",
    organizationIsActive: "组织活跃",
    organizationLogoUrl: "组织徽标",
    organizationName: "组织",
    organizationNames: "组织",
    owner: "所有者",
    ownerEmail: "所有者邮箱",
    ownerId: "所有者 ID",
    ownerName: "所有者",
    ...
    passwordExpiresUtc: "密码过期时间",
    performedBy: "操作者",
    performedByEmail: "操作者邮箱",
    performedByName: "操作者",
    permission: "权限",
    permissionCode: "权限代码",
    ...
    profileImageUrl: "头像",
    publishedAt: "发布时间",
    publishedVersionNumber: "已发布版本",
    rateLimitPerDay: "速率限制 / 天",
    rateLimitPerMinute: "速率限制 / 分钟",
    reauthenticationMaxAgeMinutes: "重新认证的最长时限（分钟）",
    recipient: "收件人",
    recipientName: "收件人姓名",
    recipientUserId: "收件人账户",
  ...
  auth: {
    ...
    passwordRulesTitle: "密码要求",
    passwordRuleMinLength: "至少 {{count}} 个字符",
    passwordRuleUppercase: "至少一个大写字母（A–Z）",
    passwordRuleLowercase: "至少一个小写字母（a–z）",
    passwordRuleDigit: "至少一个数字（0–9）",
    passwordRuleSpecial: "至少一个符号，例如 ! @ # $ %",
    passwordRuleMet: "已满足",
    passwordRuleUnmet: "尚未满足",
    ...
    haveAccount: "已有账户？",
    signUp: "注册",
    registerEmailHint: "我们将向该地址发送一个 6 位验证码，以确认它属于您。",
    sendCode: "发送验证码",
    sendingCode: "正在发送验证码…",
    requestNewCode: "发送新验证码",
    useDifferentEmail: "使用其他电子邮件地址",
    registerCompleteTitle: "设置您的账户",
    registerCompleteSubtitle: "您的地址已确认。请选择姓名和密码。",
    changeEmail: "更改电子邮件",
    showPassword: "显示密码",
    hidePassword: "隐藏密码",
    accountCreated: "您的账户已准备就绪。",
  },
  dashboard: {
    window: "时间范围",
    ...
    alertExpiringKeys: "{{count}} 个 API 密钥将在 {{days}} 天内过期",
    alertExpiringWebhookKeys: "{{count}} 个 webhook 密钥将在 {{days}} 天内过期",
    alertExpiringKeysBody:
      "最近的一个将在 {{soonest}} 天内停止工作，仍在使用它的调用方将开始失败。",
    reviewUsers: "查看用户",
    reviewKeys: "查看密钥",
    reviewWebhookKeys: "查看 webhook 密钥",
    ...
    activeTokens: "活跃刷新令牌",
    tokensHint: "过去 {{days}} 天吊销 {{revoked}} 个",
    success: "成功",
    failed: "失败",
    daily: "每日",
    weekly: "每周",
  ...
  applications: {
    ...
    deleted: "应用已删除。",
    available: "可用",
    availableHint: "关闭后无人可以登录，现有会话也会结束——包括受邀用户。",
    deactivateTitle: "关闭此应用？",
    deactivateBody:
      "将无人能够登录 {{name}}，当前已登录的所有人都会被登出。您可以随时重新开启。",
    activated: "应用已开启。",
    deactivated: "应用已关闭。",
    accessMode: "谁可以登录",
    ...
    manageAccessDescription:
      "在 {{name}} 处于受限状态时获准试用它的人员。在您向所有人开放之前，其他人无法登录。您可以在同一步骤中为每个用户分配角色。",
    accessUser: "用户",
    accessRole: "在此应用中的角色",
    accessRoleHint: "可选。没有角色时，他们可以登录但无法进行任何操作。",
    accessExpires: "访问到期",
    grantAccess: "添加用户",
    noAccessGrants: "尚无试用用户。",
    accessGranted: "已授予访问权限。",
    accessRevoked: "已移除访问权限。",
    accessVia: "访问来源",
    accessViaGrant: "试用用户",
    accessViaDirect: "直接角色",
    accessViaOrganization: "组织",
    accessViaMultiple: "多个来源",
  },
  organizations: {
    title: "组织",
  ...
  auditLogs: {
    ...
    exportFormat: "格式",
    exported: "导出已开始。",
    exportTruncatedTitle: "此导出将不完整",
    exportTruncatedBody: "共匹配 {{total}} 行，而单个文件最多容纳 {{limit}} 行。将导出最新的 {{limit}} 行，其余不包含在内。如需全部，请先缩小范围。",
    exportTruncatedConfirm: "仍要导出",
    detailTitle: "审计事件",
    oldValues: "旧值",
    newValues: "新值",
    actionCode: "代码",
    ...
    actionTypes: {
      ...
      administration: "管理",
      application: "应用",
      organizationManagement: "组织",
      apiKeyManagement: "API 密钥",
      system: "系统",
    },
    actions: {
      userLogin: "已登录",
      userLogout: "已退出登录",
      userLogoutAll: "已在所有设备退出登录",
      permissionGranted: "向用户授予权限",
      permissionRevoked: "从用户撤销权限",
      roleAssigned: "为用户分配角色",
      roleRemoved: "从用户移除角色",
      roleCreated: "创建角色",
      roleUpdated: "更新角色",
      roleDeleted: "删除角色",
      rolePermissionGranted: "为角色添加权限",
      rolePermissionRevoked: "从角色移除权限",
      passwordCreated: "为原本没有密码的账户添加密码",
      passwordChanged: "更改密码",
      twofactorEnabled: "启用两步验证",
      twofactorDisabled: "停用两步验证",
      userLocked: "锁定账户",
      userUnlocked: "解锁账户",
      externalLoginLinked: "关联外部登录提供方",
      sessionEnded: "结束会话",
      webhookkeyCreated: "创建 Webhook 签名密钥",
      webhookkeyRevoked: "吊销 Webhook 签名密钥",
      userCreated: "创建用户",
      userDeleted: "删除用户",
      userHarddeleted: "永久销毁用户",
      userDeletionRequested: "请求删除账户",
      userDeletionCancelled: "取消删除账户",
      userDeletionCompleted: "完成删除账户",
      userDeletionReapplied: "重试删除账户",
      systemSettingsUpdated: "更改系统设置",
      platformSettingsUpdated: "更改平台设置",
      notificationTemplatePublished: "发布通知模板",
      notificationTemplateUnpublished: "取消发布通知模板",
      notificationTemplateRolledBack: "回滚通知模板",
      secretsValueChanged: "更改密钥值",
      secretsOperationConfirmationRequested: "请求确认密钥操作",
      secretsOperationExecuted: "执行密钥操作",
      applicationAccessGranted: "授予应用访问权限",
      applicationAccessRevoked: "撤销应用访问权限",
      applicationActivated: "启用应用",
      applicationDeactivated: "停用应用",
      organizationOwnershipTransferInitiated: "发起组织所有权转移",
      organizationOwnershipTransferred: "转移组织所有权",
      apikeyCreated: "创建 API 密钥",
      apikeyRevoked: "吊销 API 密钥",
      systemPrivacyPolicyContentSaved: "保存隐私政策草稿",
  ...
  auditCatalog: {
    title: "审计操作目录",
    subtitle:
      "本系统记录的每一项操作，以及它所归属的类别。只读：该列表来自写入审计记录的代码，因此它说明的是实际记录的内容，而非配置的内容。",
  },
  secrets: {
    title: "机密密钥",
  ...
  notifications: {
    ...
    types: {
      ...
      welcomeEmail: "欢迎邮件",
      ownershipTransferCode: "所有权转移验证码",
      ownershipTransferred: "所有权已转移",
      accountDeletionRequested: "已请求删除账户",
      accountDeletionVerification: "删除账户验证",
      accountDeletionCancelled: "已取消删除账户",
      accountDeletionCompleted: "已完成删除账户",
      accountDeletedByAdmin: "账户已被管理员删除",
      privacyPolicyUpdated: "隐私政策已更新",
      newDeviceSignIn: "新设备登录",
      sessionsRevokedTokenReuse: "令牌重用后会话已撤销",
      sessionLimitEnforced: "因会话数量上限被登出",
  ...
  systemSettings: {
    ...
    gatewayRateLimiting: {
      ...
      registerPermitLimit: "每窗口注册请求数",
      registerPermitLimitHint:
        "仅覆盖注册接口。它是 API 部分注册限制的外层孪生项，也是真正起决定作用的一项：每个请求都先遇到这个限流器，因此在它维持低值时调高 API 侧的限制，访客不会看到任何变化。请让两者一同调整，并保持这一项不低于内层限制。",
      registerWindowSeconds: "注册窗口（秒）",
      registerWindowSecondsHint:
        "在边缘统计注册次数的时间跨度，采用同样的固定窗口机制。此处的更改需约 30 秒才能到达网关，而非立即生效，因为网关是一个自行拉取配置的独立进程——所以请在活动开始前调高，而不是等流量到来时。",
    ...
    registration: {
      title: "谁可以创建账户",
      description:
        "让未登录者获得账户的三道门。三者全部关闭，意味着账户只有管理员创建时才存在。它们是独立开关，因为关闭其一通常意味着偏好另一条路：关闭公开注册的部署，多半希望账户改为通过邀请产生。三者都不会影响已存在的账户。",
  ...
  profile: {
    ...
    browsers: "浏览器",
    browsersSubtitle:
      "您登录过的地方。退出登录只结束一个会话；移除浏览器则会删除它并结束其上的所有会话。",
    groupingCaveat:
      "浏览器是通过它自己保存的数据来识别的。清除这些数据后，同一个浏览器会在此显示为新的浏览器。",
    activeSessionsCount: "活动会话：{{n}}",
    firstSeen: "首次出现于 {{date}}",
    showSessions: "会话",
    forgetBrowser: "移除",
    forgetBrowserTitle: "要移除此浏览器吗？",
    forgetBrowserBody:
      "将删除 {{name}}，并退出其上仍然打开的所有会话。再次从该浏览器登录时会被视为新设备。",
    browserForgotten: "已移除该浏览器。",
    unattributedSessions: "其他会话",
    unattributedHelp: "未标识浏览器的会话，例如已连接的应用。",
    noBrowsers: "没有登录记录",
    noBrowsersBody: "您登录时使用的浏览器会显示在这里。",
    loadFailed: "无法加载",
    loadFailedBody: "在连接服务器的过程中出现了问题。",
    retry: "重试",
    approximateLocation: "根据 IP 地址推算的大致位置",
    loginActivity: "最近登录活动",
    loginActivitySubtitle: "您账户上最近的尝试及其结果。",
    loginSucceeded: "登录成功",
    loginFailed: "登录失败",
    loginIncomplete: "双重验证未完成",
    loginIncompleteHint: "已输入您的密码，但始终没有提交验证码。",
    loginCodeAttempts: "被拒验证码：{{count}}",
    noLoginActivity: "暂无记录",
    unrecognisedActivity: "对这里的某项没有印象？请修改密码。",
