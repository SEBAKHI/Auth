...
export const ur: TranslationResources = {
  ...
  settingsSearch: {
    ...
    hint: "کسی ترتیب کو اس کے نام یا کنفیگ کلید سے تلاش کریں۔",
    pages: "صفحات",
    recent: "حالیہ",
    ...
    noResultsFor: "”{{query}}“ سے کوئی ترتیب مماثل نہیں",
    emptySuggestion: "کم الفاظ آزمائیں، یا ترتیب کی کنفیگ کلید لکھیں۔",
