...
export const ur: TranslationResources = {
  ...
  systemSettings: {
    ...
    registration: {
      ...
      description:
        "دو دروازے جن سے کوئی اجنبی منتظم کے بغیر گزر سکتا ہے۔ دونوں بند کرنے کا مطلب ہے کہ اکاؤنٹ صرف یہاں سے بنانے یا دعوت دینے پر ہی وجود میں آئے گا؛ دونوں سوئچ پہلے سے موجود اکاؤنٹ کو نہیں چھیڑتے۔",
