  ...
  systemSettings: {
    ...
    rateLimiting: {
      ...
      registerPermitLimitHint:
        "ایک کلائنٹ IP مسترد ہونے سے پہلے کتنے نئے اکاؤنٹ بنا سکتا ہے۔ یہ اوپر کی تصدیقی حد سے الگ ہے کیونکہ رجسٹریشن کی طلب ایک واقعہ ہے جبکہ سائن اِن کی طلب ایک عادت: کوئی لانچ یا مہم ایک گھنٹے میں ہزاروں اکاؤنٹ مانگتی ہے، اور جب تک دونوں ایک ہی حصہ بانٹتے رہے، اسے پورا کرنے کا واحد راستہ سائن اِن کی حد بھی کھول دینا تھا۔ اسے مقرر کرنے کے لیے: اس عدد کو اُن کلائنٹ IP پتوں کی تعداد سے ضرب دیں جہاں سے رجسٹریشن آتی ہے، پھر ونڈو پر تقسیم کریں؛ یوں فی سیکنڈ جتنے اکاؤنٹ کی اجازت ہے وہ عدد مل جائے گا — اسے اُس رفتار سے نیچے رکھیں جو سرور ہیش کر سکتا ہے، کیونکہ ایک انکار تقریباً مفت ہے جبکہ ادھوری رجسٹریشن نہیں۔ اسے بڑھانا گنجائش نہیں بڑھاتا، بس گنجائش سے بہت نیچے کھڑا رہنا ختم کرتا ہے۔",
