...
export const ur: TranslationResources = {
  ...
  auth: {
    ...
    passwordRulesTitle: "پاس ورڈ کی شرائط",
    passwordRuleMinLength: "کم از کم {{count}} حروف",
    passwordRuleUppercase: "کم از کم ایک بڑا انگریزی حرف (A–Z)",
    passwordRuleLowercase: "کم از کم ایک چھوٹا انگریزی حرف (a–z)",
    passwordRuleDigit: "کم از کم ایک ہندسہ (0–9)",
    passwordRuleSpecial: "کم از کم ایک علامت، مثلاً ! @ # $ %",
    passwordRuleMet: "پوری ہو گئی",
    passwordRuleUnmet: "ابھی پوری نہیں ہوئی",
    passwordRulesProgress:
      "پاس ورڈ کی {{total}} شرائط میں سے {{met}} پوری ہو گئیں",
    ...
    signUp: "سائن اپ کریں",
    registerEmailHint: "ہم اس پتے پر 6 ہندسوں کا کوڈ بھیجیں گے تاکہ تصدیق ہو سکے کہ یہ آپ کا ہے۔",
    sendCode: "کوڈ بھیجیں",
    ...
    accountCreated: "آپ کا اکاؤنٹ تیار ہے۔",
  },
  dashboard: {
    window: "مدت",
    ...
    alertLockedOutBody:
      "قفل ختم ہونے یا ہٹائے جانے تک اجنبی سائن اِن نہیں کر سکتے؛ اکاؤنٹ کے مالک کی معمول کی ڈیوائس اب بھی کر سکتی ہے۔",
  ...
  auditLogs: {
    ...
    actions: {
      ...
      registrationStarted: "رجسٹریشن شروع ہوئی",
    },
  },
  auditCatalog: {
  ...
  systemSettings: {
    ...
    savedRestartNeeded:
      "ترتیبات محفوظ ہو گئیں۔ API کے دوبارہ آغاز کی متقاضی تبدیلیوں کی تعداد: {{count}}۔ یہ اگلے دوبارہ آغاز کے بعد خودکار طور پر لاگو ہو جائیں گی۔",
    resetDone: "حصہ طے شدہ ترتیبات پر واپس آ گیا۔",
    conflictTitle: "کسی اور نے تبدیل کر دیا",
    conflict:
      "آپ کی ترمیم کے دوران کسی اور نے یہ حصہ تبدیل کر دیا۔ آپ کی قدریں اب بھی یہیں اور اب بھی غیر محفوظ ہیں — دوبارہ محفوظ کرنے سے پہلے ان کا موجودہ قدروں سے موازنہ کریں۔",
    conflictFields:
    ...
    invalidInDisabledCategory:
      "«{{category}}» بند ہے، اس لیے جس قدر کی درستی درکار ہے وہ تبدیل نہیں کی جا سکتی۔ اسے دوبارہ فعال کریں، قدر درست کریں، پھر محفوظ کریں۔",
    highImpactConfirmTitle: "رسائی کو کنٹرول کرنے والی ترتیبات محفوظ کریں؟",
    highImpactConfirmBody:
      "یہ ترتیبات طے کرتی ہیں کہ کون اور کیسے سائن ان کر سکتا ہے: {{fields}}۔ سرور جس قدر کو قبول کر لے وہ بھی آپ سمیت تمام منتظمین کی رسائی ختم کر سکتی ہے۔ محفوظ کرنے سے پہلے انہیں جانچ لیں۔",
    ...
    jwt: {
      ...
      groups: {
        identity: "جاری کنندہ اور مخاطب",
        lifetimes: "ٹوکن کتنی دیر کارآمد رہتے ہیں",
        keyMaterial: "کلید مواد",
        keyMaterialDescription:
          "یہ راز کے صفحے پر مقرر ہوتے ہیں، یہاں نہیں۔ اس حصے میں صرف کلید کی شناخت رہتی ہے۔",
      },
    ...
    password: {
      ...
      groups: {
        composition: "پاس ورڈ میں کیا ہونا لازمی ہے",
        lockout: "بار بار ناکام سائن اِن کے بعد",
        hashing: "پاس ورڈ کیسے محفوظ ہوتے ہیں",
        hashingDescription:
          "ایک پاس ورڈ کی ہیشنگ کی لاگت۔ اسے بڑھانا ہر محفوظ پاس ورڈ کو مضبوط کرتا ہے اور ہر سائن اِن کو اُتنا ہی سست کر دیتا ہے۔",
      },
      ...
      maxFailedAttemptsHint:
        "اتنے غلط پاس ورڈ کے بعد اکاؤنٹ عارضی طور پر لاک ہو جاتا ہے — اجنبیوں کے لیے: جس ایڈریس سے اکاؤنٹ پچھلے 30 دنوں میں سائن اِن ہوا ہو، یا جس ڈیوائس کا زندہ سیشن ہو، وہ کوشش جاری رکھ سکتا ہے، اور یہی گنتی ہر ایڈریس کو الگ الگ بھی محدود کرتی ہے۔ تجویز: 5 — اندازے روکنے کے لیے کافی کم، اور سچی غلطیوں کی گنجائش کے لیے کافی زیادہ۔",
      lockoutDurationMinutes: "لاک کی مدت (منٹ)",
      lockoutDurationMinutesHint:
        "اکاؤنٹ کتنی دیر لاک رہتا ہے — اور ایک ایڈریس اپنے غلط پاس ورڈوں کے بعد کتنی دیر مسترد رہتا ہے۔ تجویز: 15 — حملہ آوروں پر مؤثر روک، صارف کے لیے کم زحمت کے ساتھ۔",
    ...
    rateLimiting: {
      ...
      groups: {
        windows: "ایک کلائنٹ کتنی بار کال کر سکتا ہے",
        concurrency: "بیک وقت کتنا کام چلتا ہے",
      },
      loginPermitLimit: "تصدیقی درخواستیں فی ونڈو",
      loginPermitLimitHint:
        "ایک کلائنٹ IP 429 کے ساتھ مسترد ہونے سے پہلے کتنی تصدیقی درخواستیں کر سکتا ہے۔ صرف سائن اِن نہیں: بیرونی سائن اِن، ٹوکن تبادلہ، پاس ورڈ بھول جانا، ای میل تصدیق اور دوبارہ بھیجنا، دو مرحلوں کی توثیق، دعوت کھولنا اور قبول کرنا، اکاؤنٹ حذف کرنا اور بحال کرنا، اور رازداری کارروائیوں کی توثیق بھی شامل ہیں۔ نیا اکاؤنٹ بنانا الگ سے شمار ہوتا ہے، نیچے۔ یہ دو تہوں میں سے پہلی ہے: یہ اُس حملہ آور کو سست کرتی ہے جو بہت سے اکاؤنٹ آزماتا ہے، جبکہ اکاؤنٹ لاک اُسے روکتا ہے جو ایک اکاؤنٹ پر بہت سے پاس ورڈ آزماتا ہے۔",
      ...
      registerPermitLimit: "فی ونڈو رجسٹریشن درخواستیں",
      registerPermitLimitHint:
        "ایک کلائنٹ IP مسترد ہونے سے پہلے کتنے نئے اکاؤنٹ بنا سکتا ہے۔ یہ اوپر کی تصدیقی حد سے الگ ہے کیونکہ رجسٹریشن کی طلب ایک واقعہ ہے جبکہ سائن اِن کی طلب ایک عادت: کوئی لانچ یا مہم ایک گھنٹے میں ہزاروں اکاؤنٹ مانگتی ہے، اور جب تک دونوں ایک ہی حصہ بانٹتے رہے، اسے پورا کرنے کا واحد راستہ سائن اِن کی حد بھی کھول دینا تھا۔ اسے مقرر کرنے کے لیے: اس عدد کو اُن کلائنٹ IP پتوں کی تعداد سے ضرب دیں جہاں سے رجسٹریشن آتی ہے، پھر ونڈو پر تقسیم کریں؛ یوں فی سیکنڈ جتنے اکاؤنٹ کی اجازت ہے وہ عدد مل جائے گا — اسے اُس رفتار سے نیچے رکھیں جو سرور ہیش کر سکتا ہے، کیونکہ ایک انکار تقریباً مفت ہے جبکہ ادھوری رجسٹریشن نہیں۔ اسے بڑھانا گنجائش نہیں بڑھاتا، بس گنجائش سے بہت نیچے کھڑا رہنا ختم کرتا ہے۔ یہاں محفوظ کی گئی قدر ذخیرہ ہو جاتی ہے اور ہر تعیناتی کے بعد بھی باقی رہتی ہے: بعد میں کنفیگریشن فائل میں بدلا گیا نمبر اس کے سائے میں رہتا ہے جب تک ذخیرہ شدہ قدر مٹا نہ دی جائے۔",
      registerWindowSeconds: "رجسٹریشن گنتی کی ونڈو (سیکنڈ)",
      registerWindowSecondsHint:
        "وہ مدت جس پر اوپر کی رجسٹریشن گنتی ماپی جاتی ہے، اُسی مقررہ ونڈو کے اصول پر: شمار ونڈو ختم ہونے پر صفر ہوتا ہے، سرکتا نہیں۔ دونوں خانے محفوظ کرتے ہی نئی کلائنٹ ونڈوز پر لاگو ہو جاتے ہیں، سو کسی تقریب کی حد اُس دن بڑھا کر بعد میں دوبارہ شروع کیے بغیر گھٹائی جا سکتی ہے — اور گھٹانی چاہیے، کیونکہ کھلا رجسٹریشن حصہ ایک خودکار پروگرام اُتنی ہی آسانی سے خرچ کرتا ہے جتنی ایک حقیقی ہجوم۔",
      signInPagePermitLimit: "فی وقفہ سائن اِن صفحہ لوڈز",
      signInPagePermitLimitHint:
        "سائن اِن یا سائن اپ صفحہ محض دکھائی دینے پر جو خرچ کرتا ہے: فعال بیرونی فراہم کنندگان کی فہرست، اور وہ نونس جو گوگل بٹن کو ابتدا سے پہلے تھامنا ہوتا ہے۔ ہر صفحہ کھلنے پر دو درخواستیں، یعنی اس عدد کا نصف بتاتا ہے کہ ایک کلائنٹ آئی پی ایک وقفے میں وہ صفحات کتنی بار کھول سکتا ہے۔ اسے توثیق کی حد سے الگ کیا گیا کیونکہ صفحہ دکھانا سائن اِن کی کوشش نہیں: جب تک دونوں ایک کوٹہ بانٹتے تھے، سائن اپ صفحہ کھولنا بیس میں سے دو خرچ کرتا تھا، اور ایک مشترکہ پتہ (دفتر یا موبائل نیٹ ورک) سائن اپ حد جتنی بھی زیادہ ہو، فی منٹ صرف چھ کے قریب رجسٹریشن مکمل کر پاتا تھا۔",
      signInPageWindowSeconds: "سائن اِن صفحہ گنتی کا وقفہ (سیکنڈ)",
      signInPageWindowSecondsHint:
        "اوپر کی گنتی جس مدت پر محیط ہے۔ ساٹھ سیکنڈ عام انتخاب ہے؛ لمبا وقفہ اچانک بوجھ کو ہموار کرتا ہے مگر سزا زیادہ دیر رہتی ہے۔",
      ...
      imageUploadConcurrencyLimit: "بیک وقت ڈی کوڈ ہونے والے اپ لوڈ",
      imageUploadConcurrencyLimitHint:
        "یہ ونڈو نہیں: پورے پروسیس میں ایک ہی لمحے کتنی تصاویر ڈی کوڈ ہو سکتی ہیں۔ ہر ایک WebP لکھے جانے تک زیادہ سے زیادہ میگا پکسلز × 4 MB میموری روکے رکھتی ہے، لہٰذا یہ عدد ضرب اُس بجٹ سے وہ میموری ہے جو اپ لوڈ لے سکتے ہیں۔ اگلے چار لمحہ بھر انتظار کرتے ہیں؛ اس سے زیادہ 429 اور مختصر دوبارہ کوشش کے اشارے کے ساتھ مسترد ہوتے ہیں۔",
      registrationFollowupPermitLimit: "فی ونڈو رجسٹریشن فالو اپ درخواستیں",
      registrationFollowupPermitLimitHint:
        "ایک کلائنٹ IP ایک ونڈو میں کوڈ کی تصدیق اور رجسٹریشن مکمل کرنے کی کتنی درخواستیں بھیج سکتا ہے، اس کے بعد 429 سے انکار ہو گا۔ یہ ہر پہلے-تصدیق رجسٹریشن کی دوسری اور تیسری درخواستیں ہیں، اور اوپر کی رجسٹریشن درخواستوں سے الگ گنی جاتی ہیں کیونکہ صرف پہلا مرحلہ پیغام بھیجتا ہے: دونوں کے لیے ایک نمبر یا تو ایک پتے سے ہونے والی میل کو تین گنا کر دے گا یا رجسٹریشن کو دوسرے مرحلے پر روک دے گا۔ اسے کم از کم رجسٹریشن کی حد سے دوگنا رکھیں — ہر رجسٹریشن کو ایک تصدیق اور ایک تکمیل درکار ہے — اور یاد رکھیں کہ غلط کوڈ اس حد سے بہت پہلے کوڈ کی اپنی پانچ کوششوں کی حد سے مسترد ہو جاتا ہے۔",
      registrationFollowupWindowSeconds: "رجسٹریشن فالو اپ ونڈو (سیکنڈ)",
      registrationFollowupWindowSecondsHint:
        "وہ مدت جس پر اوپر کی فالو اپ گنتی ناپی جاتی ہے، باقیوں جیسی مقررہ ونڈو کے طریقے سے: ونڈو ختم ہونے پر شمار کنندہ صفر پر آ جاتا ہے۔ محفوظ کرتے ہی نئی کلائنٹ ونڈوز پر لاگو ہوتا ہے۔",
    },
    gatewayRateLimiting: {
      ...
      groups: {
        global: "ہر چیز کے اوپر کی حد",
        perRoute: "فی راستہ حدیں",
        perRouteDescription:
          "ہر ایک راستوں کے ایک خاندان کا احاطہ کرتی ہے۔ اوپر کی عالمی حد ان سب کے اوپر لاگو ہوتی ہے، اس لیے وہ اس پالیسی سے تنگ نہیں ہونی چاہیے جسے وہ خاموشی سے محدود کر دے گی۔",
      },
      globalPermitLimit: "مجموعی درخواست کی حد",
      globalPermitLimitHint:
        "گیٹ وے سے گزرنے والی ہر درخواست پر لاگو، نیچے دی گئی ہر راستہ پالیسی کے اوپر۔ یہ ان میں سب سے تیز سے سست نہیں ہونی چاہیے، ورنہ انہیں خاموشی سے محدود کر دے گی۔",
      ...
      registerPermitLimit: "فی ونڈو رجسٹریشن درخواستیں",
      registerPermitLimitHint:
        "صرف رجسٹریشن اینڈ پوائنٹ کا احاطہ کرتی ہے۔ یہ API حصے کی رجسٹریشن حد کا بیرونی جوڑ ہے، اور فیصلہ اسی کا ہوتا ہے: ہر درخواست پہلے اِسی حد سے ملتی ہے، سو اِس کے کم رہتے ہوئے API کی حد بڑھانے سے آنے والے کو کچھ بھی مختلف نظر نہیں آئے گا۔ دونوں کو ساتھ ساتھ بدلیں، اور اِسے اندرونی حد کے برابر یا اُس سے اوپر رکھیں۔",
      registerWindowSeconds: "رجسٹریشن ونڈو (سیکنڈ)",
      registerWindowSecondsHint:
        "وہ مدت جس پر کنارے پر رجسٹریشن شمار ہوتی ہے، اُسی مقررہ ونڈو کے اصول پر۔ یہاں کی تبدیلی گیٹ وے تک فوراً نہیں بلکہ تقریباً 30 سیکنڈ میں پہنچتی ہے، کیونکہ وہ ایک الگ عمل ہے جو اپنی ترتیبات خود کھینچتا ہے — سو اسے تقریب شروع ہونے سے پہلے بڑھائیں، ٹریفک آنے کے وقت نہیں۔",
      ...
      registrationFollowupPermitLimit: "فی ونڈو رجسٹریشن فالو اپ درخواستیں",
      registrationFollowupPermitLimitHint:
        "کنارے پر رجسٹریشن کے کوڈ کی تصدیق اور تکمیل کے مراحل کو ان کے اپنے راستے پر شامل کرتا ہے۔ API حصے کی فالو اپ حد کا بیرونی جڑواں، اور جس سے زائر پہلے ملتا ہے: اسے اندرونی حد کے برابر یا اس سے اوپر رکھیں، اور ساتھ والی رجسٹریشن حد سے کم از کم دوگنا، ورنہ رجسٹریشن شمار کنندہ میں گنجائش ہونے کے باوجود رجسٹریشنیں دوسرے مرحلے پر مسترد ہوں گی۔",
      registrationFollowupWindowSeconds: "رجسٹریشن فالو اپ ونڈو (سیکنڈ)",
      registrationFollowupWindowSecondsHint:
        "وہ مدت جس پر کنارے پر فالو اپ درخواستیں گنی جاتی ہیں، اسی مقررہ ونڈو کے طریقے سے۔ تبدیلی گیٹ وے تک فوراً نہیں بلکہ تقریباً 30 سیکنڈ میں پہنچتی ہے کیونکہ وہ اپنی ترتیبات خود کھینچتا ہے — اسے ایونٹ شروع ہونے سے پہلے بڑھائیں۔",
    },
    externalAuth: {
      ...
      title: "بیرونی فراہم کنندہ سے سائن ان",
      description:
        "ایسے اکاؤنٹ سے سائن اِن جو صارف کے پاس پہلے سے کہیں اور موجود ہے۔ یہاں دیے گئے کلائنٹ ID عوامی شناختیں ہیں؛ نجی کلیدیں راز کے صفحے پر رہتی ہیں۔ بٹن ظاہر ہونے کے لیے فراہم کنندہ کو اس کی ڈائریکٹری قطار میں بھی فعال ہونا لازمی ہے۔",
      groups: { general: "ہر فراہم کنندہ پر لاگو" },
      incompleteTitle: "نامکمل اسناد",
      incompleteBody:
        "یہ فراہم کنندہ آن ہے، مگر جب تک یہاں کوئی بھی سند خالی ہے اس کا سائن اِن بٹن ظاہر نہیں ہوگا۔",
    ...
    registration: {
      title: "اکاؤنٹ کون بنا سکتا ہے",
      description:
        "تین دروازے جن سے کسی غیر سائن اِن شخص کا اکاؤنٹ وجود میں آتا ہے۔ تینوں بند کرنے کا مطلب ہے کہ اکاؤنٹ صرف منتظم کے بنانے پر وجود میں آئے۔ یہ الگ سوئچ ہیں کیونکہ ایک بند کرنے کا مطلب عموماً دوسرے کو ترجیح دینا ہوتا ہے: جو عوامی سائن اپ بند کرتا ہے وہ اکثر چاہتا ہے کہ اکاؤنٹس دعوت سے آئیں۔ ان میں سے کوئی بھی پہلے سے موجود اکاؤنٹ کو نہیں چھیڑتا۔",
      allowSelfRegistration: "عوامی رجسٹریشن",
      allowSelfRegistrationHint:
        "رجسٹریشن فارم کے پیچھے کا اینڈ پوائنٹ۔ گزرنے والی ہر درخواست ایک پاس ورڈ ہیش، ایک صارف کی سطر، اور لکھے گئے پتے پر بھیجی گئی ایک ای میل کی قیمت رکھتی ہے؛ جو سرور عوامی رجسٹریشن نہیں چاہتا اسے یہ سب خرچ کرنے سے پہلے انکار کرنا چاہیے۔ بند ہونے پر ہر پتے کو ایک ہی جواب ملتا ہے، اس لیے یہ ظاہر نہیں ہوتا کہ یہاں کون رجسٹرڈ ہے۔ فارم خود چھپایا نہیں جاتا — کوئی چیز اس ترتیب کو رجسٹریشن صفحے تک نہیں پہنچاتی — چنانچہ آنے والا اسے بھرتا ہے اور جمع کراتے وقت انکار پاتا ہے۔ دعوتیں اور منتظم کے بنائے ہوئے صارفین متاثر نہیں ہوتے۔",
      allowExternalProvisioning: "Google یا Apple کے ذریعے رجسٹریشن",
      allowExternalProvisioningHint:
        "کیا کوئی فراہم کنندہ شناخت جو یہاں کے کسی اکاؤنٹ سے میل نہیں کھاتی، پہلی بار سائن اِن پر اکاؤنٹ بنا سکتی ہے۔ یہ دوسرے راستے سے خود رجسٹریشن ہے، اور جب تک آپ اسے بھی بند نہ کریں، اوپر والا سوئچ بند ہونے کے باوجود یہ کھلا رہتا ہے۔ دونوں صورتوں میں موجود اکاؤنٹس سائن اِن کرتے رہتے ہیں، اور فراہم کنندہ کو اسی پتے والے اکاؤنٹ سے جوڑا جا سکتا ہے۔",
      allowInvitationRegistration: "دعوت کے ذریعے رجسٹریشن",
      allowInvitationRegistrationHint:
        "کیا کسی تنظیم کی دعوت استعمال کرنے سے اکاؤنٹ بن سکتا ہے۔ عوامی سائن اپ بند کرنے کا عام مطلب یہ ہوتا ہے کہ اکاؤنٹس دعوت سے آئیں، اس لیے یہ الگ سوئچ ہے؛ تینوں بند کر دیں تو اکاؤنٹ صرف منتظم کے بنانے سے وجود میں آتا ہے۔ بھیجی جا چکی دعوتیں منسوخ نہیں ہوتیں، اور جس کے پاس پہلے سے اکاؤنٹ ہے وہ دعوت قبول کر سکتا ہے، کیونکہ اس سے رکنیت شامل ہوتی ہے، اکاؤنٹ نہیں بنتا۔",
    },
    organizations: {
      title: "تنظیم کون بنا سکتا ہے",
      description:
    ...
    email: {
      ...
      groups: {
        server: "میل سرور",
        sender: "بھیجنے والا اور روابط",
        codes: "کوڈ اور بھیجنے کی حدیں",
        codesDescription:
          "یہ خود کوڈوں اور روابط کو چلاتے ہیں، سرور سے تعلق کو نہیں۔",
      },
      smtpHost: "SMTP سرور",
    ...
    notificationsSection: {
      ...
      groups: {
        delivery: "پیغامات کیسے پہنچائے جاتے ہیں",
      },
    ...
    imageStorage: {
      ...
      groups: {
        location: "ذخیرہ اور ترسیل",
        limits: "کون سی اپ لوڈ قبول ہوتی ہیں",
      },
      ...
      maxMegapixelsHint:
        "پروسیسنگ سے پہلے ڈی کمپریشن بم مسترد کرتا ہے۔ تجویز: 24 — قبول ہونے والا ہر میگا پکسل تصویر ڈی کوڈ ہوتے وقت 4 MB میموری لیتا ہے، اور یہ حد اپ لوڈ کی ہم وقتی حد کے ساتھ کام کرتی ہے۔",
    ...
    accountDeletionSection: {
      ...
      groups: {
        request: "اکاؤنٹ حذف کرنے والے کو کیا نظر آتا ہے",
        execution: "حذف کیسے انجام پاتا ہے",
      },
    ...
    dataController: {
      ...
      groups: {
        identity: "ڈیٹا کنٹرولر کون ہے",
        processors: "اس کی جانب سے ڈیٹا کون پروسیس کرتا ہے",
        registrations: "ترکی کی رجسٹریشنیں",
        registrationsDescription:
          "دونوں اختیاری ہیں۔ صرف اسی صورت بھریں جب کنٹرولر ترکی میں رجسٹرڈ ہو۔",
      },
    ...
    expiredDataCleanup: {
      ...
      groups: {
        sweeper: "صفائی کیسے چلتی ہے",
        retention: "مردہ ریکارڈ کتنی دیر رکھے جاتے ہیں",
        retentionDescription:
          "ان کے تحت آنے والی ہر قطار پہلے ہی ختم ہو چکی ہے۔ سوال یہ ہے کہ وہ اس بات کے ثبوت کے طور پر کتنی دیر کارآمد رہتی ہے کہ کچھ ہوا تھا۔",
      },
      ...
      pendingRegistrationDays: "زیرِ التوا رجسٹریشنز (دن)",
      pendingRegistrationDaysHint:
        "وہ رجسٹریشن کوششیں جن کا کوڈ ختم ہو چکا ہے، مکمل ہوئی ہوں یا نہیں۔ اس بات کے ثبوت کے طور پر رکھی جاتی ہیں کہ کس نے کس پتے سے رجسٹر ہونے کی کوشش کی۔ تجویز: 7۔",
    },
    dataRetention: {
