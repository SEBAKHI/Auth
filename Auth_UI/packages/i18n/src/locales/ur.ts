...
export const ur: TranslationResources = {
  ...
  systemSettings: {
    ...
    resetSection: "فائل کی قدروں پر واپس لائیں",
    resetConfirmTitle: "یہ حصہ ری سیٹ کریں؟",
    resetConfirmBody:
      "اس حصے کی تمام ترمیم شدہ قدریں ہٹا دی جائیں گی اور کنفیگریشن فائلوں کی قدریں دوبارہ لاگو ہو جائیں گی۔",
    saved: "ترتیبات محفوظ ہو گئیں۔",
    resetDone: "حصہ فائل کی قدروں پر واپس آ گیا۔",
    conflict:
    ...
    password: {
      ...
      expirationDays: "پاس ورڈ کی میعاد (دن)",
      expirationDaysHint:
        "اتنے دنوں کے بعد پاس ورڈ کی تبدیلی لازمی کریں۔ تجویز: 0 (بند) — NIST معمول کی میعاد مقرر کرنے کے خلاف مشورہ دیتا ہے؛ اس کے بجائے افشا شدہ پاس ورڈ کی جانچ پر انحصار کریں۔",
    ...
    rateLimiting: {
      ...
      permitLimit: "عمومی درخواستیں فی ونڈو",
      permitLimitHint: "تجویز: 100 — حقیقی صارفین کے لیے فراخ، اسکرپٹس کے لیے پابند۔",
      windowSeconds: "عمومی ونڈو (سیکنڈ)",
      windowSecondsHint: "تجویز: 60۔",
      queueLimit: "قطار کا سائز",
      queueLimitHint:
        "حد پوری ہونے پر درخواستیں فوراً ناکام ہونے کے بجائے تھوڑی دیر روکی جاتی ہیں۔ تجویز: 10۔",
    ...
    accountDeletionSection: {
      title: "اکاؤنٹ کا حذف",
      description:
        "GDPR/KVKK حذف کی پائپ لائن: مستقل مٹانے سے پہلے مہلت کی مدت، پس منظر ورکر کی رفتار، اور سلامتی کے ریکارڈ کتنی دیر محفوظ رہتے ہیں۔",
