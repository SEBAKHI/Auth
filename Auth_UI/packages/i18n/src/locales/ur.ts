...
export const ur: TranslationResources = {
  ...
  notifications: {
    ...
    manageVariablesHint:
      "یہ وہ متغیرات ہیں جو یہ اطلاعی قسم اپنے سانچوں کو فراہم کرتی ہے۔ کیٹلاگ بھیجنے والے کوڈ کے ساتھ معاہدہ ہے: سانچہ صرف یہاں درج متغیرات کا حوالہ دے سکتا ہے۔",
    variablesContextHint:
      "ہمیشہ دستیاب (شامل کرنے کی ضرورت نہیں): {{ Platform.Name }}، {{ Application.Name }}، {{ Application.Code }}، {{ SenderName }}، {{ Year }}۔ وصول کنندہ اور فلو مخصوص اقدار بھیجنے والا کوڈ فراہم کرتا ہے۔",
    customVariableWarning:
      "یہاں شامل کیا گیا متغیر صرف اسی صورت ڈیٹا رکھتا ہے جب بھیجنے والا کوڈ (یا اوپر کوئی سیاق آبجیکٹ) اسے فراہم کرے؛ ورنہ خالی ظاہر ہوتا ہے۔",
    variableName: "نام",
