  ...
  systemSettings: {
    ...
    session: {
      ...
      terminateSessionsOnPasswordResetHint:
        "جب پاس ورڈ ای میل لنک کے ذریعے ری سیٹ ہوتا ہے تو تمام موجودہ سیشنز ختم ہو جاتے ہیں۔ تجویز: آن — ری سیٹ اکثر کسی مشتبہ خلاف ورزی کے بعد ہوتا ہے۔ سنگل سائن آن سیشن ہمیشہ ختم ہوتا ہے، چاہے یہ آپشن بند ہو۔",
    },
    gateway: {
      title: "گیٹ وے تحفظ",
      description:
