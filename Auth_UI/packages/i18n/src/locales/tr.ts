...
export const tr: TranslationResources = {
  ...
  settingsSearch: {
    ...
    hint: "Bir ayarı adıyla veya yapılandırma anahtarıyla bulun.",
    pages: "Sayfalar",
    ...
    noResultsFor: "“{{query}}” ile eşleşen ayar yok",
    emptySuggestion: "Daha az kelime deneyin veya ayarın yapılandırma anahtarını yazın.",
