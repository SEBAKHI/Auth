...
export const tr: TranslationResources = {
  ...
  auth: {
    ...
    passwordRulesTitle: "Parola gereksinimleri",
    passwordRuleMinLength: "En az {{count}} karakter",
    passwordRuleUppercase: "En az bir büyük harf (A–Z)",
    passwordRuleLowercase: "En az bir küçük harf (a–z)",
    passwordRuleDigit: "En az bir rakam (0–9)",
    passwordRuleSpecial: "En az bir simge, örneğin ! @ # $ %",
    passwordRuleMet: "Karşılandı",
    passwordRuleUnmet: "Henüz karşılanmadı",
    passwordRulesProgress:
      "{{total}} parola gereksiniminden {{met}} tanesi karşılandı",
    ...
    signUp: "Kaydol",
    registerEmailHint: "Bu adresin size ait olduğunu doğrulamak için 6 haneli bir kod göndereceğiz.",
    sendCode: "Kod gönder",
    ...
    accountCreated: "Hesabınız hazır.",
  },
  dashboard: {
    window: "Dönem",
