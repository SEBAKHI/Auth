...
export const ar: TranslationResources = {
  ...
  systemSettings: {
    ...
    registration: {
      ...
      description:
        "البابان اللذان يعبر منهما الغريب بلا مسؤول. إغلاقهما معًا يعني ألّا توجد حسابات إلّا بإنشاءٍ من هنا أو بدعوة؛ ولا يمسّ أيٌّ من المفتاحين حسابًا قائمًا بالفعل.",
