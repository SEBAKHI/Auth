...
export const ar: TranslationResources = {
  ...
  notifications: {
    ...
    manageVariablesHint:
      "هذه المتغيرات التي يوفّرها نوع الإشعار لقوالبه. الكتالوج هو العقد مع كود الإرسال: لا يمكن للقالب أن يشير إلا إلى متغيرات مدرجة هنا.",
    variablesContextHint:
      "متاحة دائمًا (لا حاجة لإضافتها): {{ Platform.Name }} و{{ Application.Name }} و{{ Application.Code }} و{{ SenderName }} و{{ Year }}. القيم الخاصة بالمستلم والتدفق يوفّرها كود الإرسال.",
    customVariableWarning:
      "المتغير الذي تضيفه هنا لا يحمل بيانات إلا إذا وفّره كود الإرسال (أو كائن سياق أعلاه)؛ وإلا يُعرض فارغًا.",
    variableName: "الاسم",
