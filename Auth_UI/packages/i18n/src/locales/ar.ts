  ...
  systemSettings: {
    ...
    session: {
      ...
      terminateSessionsOnPasswordResetHint:
        "عند إعادة تعيين كلمة المرور عبر رابط البريد الإلكتروني، تُنهى جميع الجلسات القائمة. الموصى به: مفعّل — فإعادة التعيين كثيرًا ما تأتي بعد اشتباه في اختراق. وجلسة الدخول الموحّد تنتهي في الحالتين، حتى لو كان المفتاح معطّلًا.",
    },
    gateway: {
      title: "حماية البوابة",
      description:
