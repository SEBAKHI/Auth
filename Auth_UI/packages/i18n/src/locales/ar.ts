...
export const ar: TranslationResources = {
  ...
  systemSettings: {
    ...
    overridden: "مخصص",
    fileValue: "قيمة الملف: {{value}}",
    notSet: "غير محدد",
    managedInSecrets:
      "قيمة سرية — تُخزن مشفرة وتُدار في صفحة الأسرار، وليس هنا أبدًا.",
    openSecrets: "فتح الأسرار",
    readOnly: "للقراءة فقط",
    resetSection: "إعادة التعيين إلى قيم الملفات",
    resetConfirmTitle: "إعادة تعيين هذا القسم؟",
    resetConfirmBody:
      "ستُزال جميع القيم المخصصة في هذا القسم، وستسري قيم ملفات الإعداد من جديد.",
    saved: "تم حفظ الإعدادات.",
    resetDone: "تمت إعادة تعيين القسم إلى قيم الملفات.",
    conflict:
