...
export const ar: TranslationResources = {
  ...
  systemSettings: {
    ...
    password: {
      ...
      expirationDays: "انتهاء صلاحية كلمة المرور (أيام)",
      expirationDaysHint:
        "فرض تغيير كلمة المرور بعد هذا العدد من الأيام. الموصى به: 0 (معطل) — إذ تنصح NIST بعدم فرض الانتهاء الدوري؛ فاعتمد على فحص كلمات المرور المسربة بدلًا منه.",
