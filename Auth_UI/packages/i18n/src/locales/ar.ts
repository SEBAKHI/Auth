...
export const ar: TranslationResources = {
  ...
  fields: {
    ...
    acceptedByUser: "قُبلت بواسطة",
    acceptedByUserId: "قُبلت بواسطة",
    acceptedByUserName: "قُبلت بواسطة",
    ...
    applicationLogoUrl: "شعار التطبيق",
    applicationName: "التطبيق",
    ...
    description: "الوصف",
    disclosureOutOfDate: "الإفصاح غير محدَّث",
    displayName: "الاسم الظاهر",
    draftContent: "محتوى المسودة",
    draftStringsJson: "نصوص المسودة",
    draftVersionNumber: "إصدار المسودة",
    effectiveDateUtc: "تاريخ السريان",
    email: "البريد الإلكتروني",
    emailConfirmed: "البريد مؤكد",
    enabledAppCount: "التطبيقات المُفعّلة",
    enabledAt: "تاريخ التفعيل",
    enabledBy: "فُعّل بواسطة",
    enabledByName: "فُعّل بواسطة",
    ...
    hasUnpublishedChanges: "له تغييرات غير منشورة",
    id: "المعرّف",
    invitedBy: "دُعي بواسطة",
    invitedByEmail: "بريد الداعي",
    invitedByName: "دُعي بواسطة",
    ipAddress: "عنوان IP",
    isActive: "نشط",
    isDeleted: "محذوف",
    isExpired: "منتهٍ",
    ...
    modifiedAt: "تاريخ التعديل",
    modifiedBy: "عُدّل بواسطة",
    modifiedByName: "عُدّل بواسطة",
    mustChangePassword: "يجب تغيير كلمة المرور",
    name: "الاسم",
    newValues: "القيم الجديدة",
    nextAttemptAt: "المحاولة التالية",
    notificationTypeCode: "رمز النوع",
    notificationTypeId: "معرّف النوع",
    notifiedAtUtc: "تاريخ الإخطار",
    ...
    organizationNames: "المنظمات",
    owner: "المالك",
    ownerEmail: "بريد المالك",
    ownerId: "معرّف المالك",
    ownerName: "المالك",
    parentId: "الصلاحية الأم",
    passwordChangedAt: "تاريخ تغيير كلمة المرور",
    passwordExpiresUtc: "انتهاء كلمة المرور",
    performedBy: "المنفّذ",
    performedByEmail: "بريد المنفّذ",
    performedByName: "المنفّذ",
    permission: "الصلاحية",
    permissionCode: "رمز الصلاحية",
    permissionDescription: "وصف الصلاحية",
    permissionId: "معرّف الصلاحية",
    ...
    publishedVersionNumber: "الإصدار المنشور",
    rateLimitPerDay: "حد المعدل / يوم",
    rateLimitPerMinute: "حد المعدل / دقيقة",
    reauthenticationMaxAgeMinutes: "الحد الأقصى لعمر إعادة المصادقة (بالدقائق)",
    recipient: "المستلم",
    recipientName: "اسم المستلم",
    recipientUserId: "حساب المستلم",
    ...
    templateVersionId: "معرّف إصدار القالب",
    templateVersionNumber: "إصدار القالب",
    theme: "السمة",
    ...
    userRole: "دورك",
    version: "الإصدار",
    viaDirect: "ممنوح مباشرةً",
    viaOrganization: "ممنوح عبر منظمة",
    viaRole: "ممنوح عبر دور",
  ...
  auth: {
    ...
    passwordRulesTitle: "شروط كلمة المرور",
    passwordRuleMinLength: "{{count}} من الأحرف على الأقل",
    passwordRuleUppercase: "حرف لاتيني كبير واحد على الأقل (A–Z)",
    passwordRuleLowercase: "حرف لاتيني صغير واحد على الأقل (a–z)",
    passwordRuleDigit: "رقم واحد على الأقل (0–9)",
    passwordRuleSpecial: "رمز واحد على الأقل، مثل ! @ # $ %",
    passwordRuleMet: "مستوفى",
    passwordRuleUnmet: "غير مستوفى بعد",
    passwordRulesProgress: "استُوفي {{met}} من {{total}} من شروط كلمة المرور",
    ...
    signUp: "سجّل الآن",
    registerEmailHint: "سنرسل رمزًا من 6 أرقام إلى هذا العنوان للتأكد من أنه عنوانك.",
  ...
  dashboard: {
    ...
    alertLockedOutBody:
      "لا يستطيع الغرباء تسجيل الدخول حتى ينتهي القفل أو يُرفع؛ وجهاز صاحب الحساب المعتاد يبقى قادرًا.",
  ...
  auditLogs: {
    ...
    exportTruncatedTitle: "هذا التصدير سيكون ناقصاً",
    exportTruncatedBody: "يطابق {{total}} صفاً، والملف يسع {{limit}} على الأكثر. سيُصدَّر أحدث {{limit}} ويُترك الباقي. ضيِّق النطاق أولاً إن كنت تحتاجها كلها.",
    exportTruncatedConfirm: "صدِّر على أي حال",
    ...
    actions: {
      ...
      registrationStarted: "بدء تسجيل حساب",
    },
  },
  auditCatalog: {
  ...
  notifications: {
    ...
    types: {
      ...
      organizationInvitation: "دعوة إلى مؤسسة",
      welcomeEmail: "رسالة ترحيب",
      ownershipTransferCode: "رمز نقل الملكية",
      ownershipTransferred: "اكتمال نقل الملكية",
      accountDeletionRequested: "طلب حذف الحساب",
      accountDeletionVerification: "تأكيد حذف الحساب",
      accountDeletionCancelled: "إلغاء حذف الحساب",
      accountDeletionCompleted: "اكتمال حذف الحساب",
      accountDeletedByAdmin: "حذف الحساب من قِبَل مسؤول",
      privacyPolicyUpdated: "تحديث سياسة الخصوصية",
      newDeviceSignIn: "تسجيل دخول من جهاز جديد",
      sessionsRevokedTokenReuse: "إبطال الجلسات بعد إعادة استخدام رمز",
      sessionLimitEnforced: "تسجيل خروج بسبب حد الجلسات",
  ...
  systemSettings: {
    ...
    savedRestartNeeded:
      "تم حفظ الإعدادات. عدد التغييرات التي تتطلب إعادة تشغيل واجهة API: {{count}}. وستسري تلقائيًا بعد إعادة التشغيل التالية.",
    resetDone: "أُعيد ضبط القسم إلى الإعدادات الافتراضية.",
    conflictTitle: "تعديل من شخص آخر",
    conflict:
      "غيَّر شخص آخر هذا القسم أثناء تحريرك له. قيمك لا تزال هنا ولا تزال غير محفوظة — قارنها بالقيم الحالية قبل الحفظ من جديد.",
    conflictFields:
    ...
    highImpactConfirmTitle: "حفظ إعدادات تتحكم في الوصول؟",
    highImpactConfirmBody:
      "هذه الإعدادات تحدد من يستطيع تسجيل الدخول وكيف: {{fields}}. وحتى القيمة التي يقبلها الخادم قد تمنع جميع المسؤولين من الدخول، وأنت منهم. تحقق منها قبل الحفظ.",
    ...
    jwt: {
      ...
      groups: {
        identity: "المُصدِر والجمهور",
        lifetimes: "مدة صلاحية الرموز",
        keyMaterial: "مادة المفاتيح",
        keyMaterialDescription:
          "تُضبط ضمن «إدارة الأسرار» لا هنا. ولا يعيش في هذا القسم إلا معرّف المفتاح.",
      },
    ...
    password: {
      ...
      groups: {
        composition: "ما يجب أن تحتويه كلمة المرور",
        lockout: "بعد محاولات دخول فاشلة متكرّرة",
        hashing: "كيف تُخزَّن كلمات المرور",
        hashingDescription:
          "كلفة تجزئة كلمة مرور واحدة. رفعها يقوّي كل كلمة مرور مخزّنة ويُبطئ كل عملية دخول بالقدر نفسه.",
      },
      ...
      maxFailedAttemptsHint:
        "بعد هذا العدد من كلمات المرور الخاطئة يُقفل الحساب مؤقتًا — في وجه الغرباء: العنوان الذي دخل به الحساب خلال 30 يومًا، أو الجهاز الذي له جلسة حيّة، يبقى قادرًا على المحاولة، والعدد نفسه يحدّ كلّ عنوانٍ على حدة. الموصى به: 5 — منخفض بما يكفي لإيقاف التخمين، ومرتفع بما يكفي للأخطاء العفوية.",
      lockoutDurationMinutes: "مدة القفل (دقائق)",
      lockoutDurationMinutesHint:
        "مدة بقاء الحساب مقفلًا — ومدة رفض العنوان الواحد بعد كلمات مروره الخاطئة. الموصى به: 15 — كابح فعّال للمهاجمين مع إزعاج محدود للمستخدم.",
    ...
    rateLimiting: {
      ...
      groups: {
        windows: "كم مرّة يجوز للعميل أن ينادي",
        concurrency: "كم من العمل يجري في آنٍ واحد",
      },
      loginPermitLimit: "طلبات المصادقة لكل نافذة",
      loginPermitLimitHint:
        "عدد طلبات المصادقة المسموح بها لعنوان IP واحد قبل رفضه بالرمز 429. لا يقتصر على تسجيل الدخول: يشمل الدخول الخارجي وتبادل الرموز و«نسيت كلمة المرور» وتأكيد البريد وإعادة إرساله والتحقق بخطوتين وفتح الدعوات وقبولها وطلبات حذف الحساب واستعادته وتحدّيات عمليات الأسرار. أما إنشاء حساب جديد فيُعدّ على حدة، أدناه. هذه أولى طبقتين: تُبطئ مهاجمًا يجرّب حسابات كثيرة، بينما يوقف قفلُ الحساب من يجرّب كلمات مرور كثيرة على حساب واحد.",
      ...
      registerPermitLimit: "طلبات إنشاء الحسابات لكل نافذة",
      registerPermitLimitHint:
        "عدد الحسابات الجديدة التي يجوز لعنوان IP واحد إنشاؤها قبل رفضه بالرمز 429. مفصول عن حدّ المصادقة أعلاه لأن الطلب على إنشاء الحسابات حدثٌ عارض بينما الطلب على تسجيل الدخول عادةٌ مستمرة: إطلاقُ منتج أو حملةٌ تسويقية يطلب آلاف الحسابات في ساعة، وما دام الحدّان مشتركين فالسبيل الوحيد لخدمة ذلك كان توسيع حدّ تسجيل الدخول معه. لضبطه: اضرب هذا العدد في عدد عناوين IP التي تصل منها طلبات التسجيل، واقسم على النافذة، فتحصل على عدد الحسابات في الثانية الذي يسمح به — وأبقِه دون ما يستطيع الخادم تجزئته، فالرفض شبه مجاني بينما التسجيل الناقص ليس كذلك. رفعه لا يزيد الطاقة، بل يوقف الوقوف دونها. القيمة المحفوظة هنا تُخزَّن وتبقى بعد كل نشر: أي رقمٍ يُغيَّر لاحقًا في ملف الإعدادات يظل محجوبًا بها حتى تُمسح القيمة المخزَّنة.",
      registerWindowSeconds: "نافذة عدّ إنشاء الحسابات (ثوانٍ)",
      registerWindowSecondsHint:
        "المدة التي يُحسب خلالها عدد التسجيلات أعلاه، بالآلية الثابتة نفسها: العدّاد يعود إلى الصفر عند نهاية النافذة ولا ينزلق معها. يسري الحقلان على النوافذ الجديدة فور الحفظ، فيمكن رفع الحدّ ليوم حدث ثم خفضه بعده بلا إعادة تشغيل — وينبغي ذلك، لأن حصة تسجيل واسعة يستطيع برنامج آليّ إنفاقها بالسهولة نفسها التي ينفقها بها جمهور حقيقي.",
      signInPagePermitLimit: "تحميلات صفحة الدخول في النافذة",
      signInPagePermitLimitHint:
        "ما تنفقه صفحة الدخول أو التسجيل بمجرّد عرضها: قائمة مزوّدي الهويّة المفعّلين، والقيمة العشوائيّة التي يحتاجها زرّ Google قبل تهيئته. طلبان لكلّ فتح صفحة، فنصف هذا الرقم هو عدد المرّات التي يفتح فيها العنوان الواحد تلك الصفحات في النافذة. فُصل عن حدّ المصادقة لأنّ عرض الصفحة ليس محاولة دخول: حين كانا يتقاسمان حدًّا واحدًا، كان فتح صفحة التسجيل ينفق اثنين من عشرين، فلا يُتمّ العنوان المشترك (مكتب أو مشغّل هاتف) أكثر من ستّة تسجيلات في الدقيقة مهما ارتفع حدّ التسجيل.",
      signInPageWindowSeconds: "نافذة عدّ صفحة الدخول (بالثواني)",
      signInPageWindowSecondsHint:
        "المدّة التي يغطّيها العدّ أعلاه. ستّون ثانية هي الخيار المعتاد؛ والنافذة الأطول تُنعّم الدفقات وتعاقبها مدّةً أطول.",
      ...
      imageUploadConcurrencyLimit: "عمليات الرفع الجارية معًا",
      imageUploadConcurrencyLimitHint:
        "ليس نافذة زمنية: كم صورة يجوز أن تكون في طور فكّ الترميز في اللحظة نفسها على مستوى العملية كلها. كل واحدة تحجز أقصى عدد للميغابكسل × 4 ميغابايت من الذاكرة حتى تُكتب صورة WebP، فهذا الرقم مضروبًا في تلك الميزانية هو ما يجوز للرفع أن يشغله من الذاكرة. الأربع التالية تنتظر لحظة، وما زاد يُرفَض بـ429 مع تلميح قصير لإعادة المحاولة.",
      registrationFollowupPermitLimit: "طلبات متابعة التسجيل لكل نافذة",
      registrationFollowupPermitLimitHint:
        "كم عملية تحقق من الرمز وإكمالٍ للتسجيل يجوز لعنوان IP واحد أن يرسلها في النافذة قبل الرفض بـ429. هذان هما الطلبان الثاني والثالث من كل تسجيلٍ بالتحقق أولًا، ويُعدّان بمعزلٍ عن طلبات التسجيل أعلاه لأن الخطوة الأولى وحدها ترسل رسالة: رقمٌ واحد للاثنين إمّا أن يضاعف البريد الذي يسببه عنوان واحد ثلاث مرات أو يخنق التسجيل عند خطوته الثانية. أبقِه ضعف حدّ التسجيل على الأقل، فكل تسجيل يحتاج تحققًا واحدًا وإكمالًا واحدًا، وتذكّر أن الرمز الخاطئ يُرفض بحدّ المحاولات الخمس للرمز نفسه قبل هذا الحدّ بكثير.",
      registrationFollowupWindowSeconds: "نافذة متابعة التسجيل (ثوانٍ)",
      registrationFollowupWindowSecondsHint:
        "المدة التي يُقاس عليها عدّ المتابعة أعلاه، بآلية النافذة الثابتة نفسها: يعود العدّاد إلى الصفر عند انتهاء النافذة. يسري على نوافذ العملاء الجديدة فور الحفظ.",
    },
    gatewayRateLimiting: {
      ...
      groups: {
        global: "السقف الذي يعلو كل شيء",
        perRoute: "حدود بحسب المسار",
        perRouteDescription:
          "كلٌّ منها يغطّي عائلة مسارات واحدة. والسقف العام أعلاه يُطبَّق فوقها جميعًا، فلا يجوز أن يكون أضيق من السياسة التي سيحدّها في صمت.",
      },
      globalPermitLimit: "السقف العام للطلبات",
      globalPermitLimitHint:
        "يسري على كل طلب يمرّ بالبوابة، فوق كل سياسة مسار أدناه. يجب ألّا يكون أبطأ من أسرعها، وإلا قيّدها بصمت.",
      ...
      registerPermitLimit: "طلبات إنشاء الحسابات لكل نافذة",
      registerPermitLimitHint:
        "تغطي نقطة إنشاء الحساب وحدها. التوأم الخارجي لحدّ التسجيل في قسم الـAPI، وهو صاحب القرار: كل طلب يمرّ بهذا الحدّ أولًا، فرفعُ حدّ الـAPI مع بقاء هذا منخفضًا لا يغيّر شيئًا يراه الزائر. حرّك الاثنين معًا، وأبقِ هذا عند الداخلي أو فوقه.",
      registerWindowSeconds: "نافذة إنشاء الحسابات (ثوانٍ)",
      registerWindowSecondsHint:
        "المدة التي تُحسب خلالها التسجيلات عند الحافة، بالآلية الثابتة نفسها. التغيير هنا يصل البوابة خلال نحو 30 ثانية لا فورًا، لأنها عملية منفصلة تسحب إعداداتها — فارفعه قبل بدء الحدث، لا مع وصول الزحام.",
      ...
      registrationFollowupPermitLimit: "طلبات متابعة التسجيل لكل نافذة",
      registrationFollowupPermitLimitHint:
        "يغطي خطوتي التحقق من الرمز والإكمال في التسجيل عند الحافة، على مسارٍ خاصٍّ بهما. التوأم الخارجي لحدّ المتابعة في قسم الواجهة البرمجية، وهو ما يلقاه الزائر أولًا: أبقِه عند الحدّ الداخلي أو فوقه، وضعف حدّ التسجيل المجاور على الأقل، وإلا رُفضت التسجيلات عند خطوتها الثانية بينما لا يزال في عدّاد التسجيل متّسع.",
      registrationFollowupWindowSeconds: "نافذة متابعة التسجيل (ثوانٍ)",
      registrationFollowupWindowSecondsHint:
        "المدة التي تُعدّ عليها طلبات المتابعة عند الحافة، بآلية النافذة الثابتة نفسها. يصل التغيير إلى البوابة خلال نحو 30 ثانية لا فورًا لأنها تسحب إعداداتها بنفسها، فارفعه قبل بدء الحدث.",
    },
    externalAuth: {
      ...
      title: "الدخول عبر مزوّد خارجي",
      description:
        "الدخول بحسابٍ يملكه الشخص أصلًا في مكانٍ آخر. معرّفات العملاء هنا معرّفات عامة؛ أما المفاتيح الخاصة فتُحفظ ضمن «إدارة الأسرار». يجب أيضًا تفعيل المزوّد في صفّه بالدليل حتى يظهر زرّه.",
      groups: { general: "ينطبق على كل مزوّد" },
      incompleteTitle: "بيانات اعتماد ناقصة",
      incompleteBody:
        "هذا المزوّد مفعّل، لكن زرّ الدخول يبقى مخفيًّا ما دام أيٌّ من بيانات الاعتماد هنا فارغًا.",
    ...
    registration: {
      title: "من يحقّ له إنشاء حساب",
      description:
        "الأبواب الثلاثة التي يوجد منها حسابٌ لمن ليس مسجَّل الدخول. إغلاقها جميعًا يعني ألّا يوجد حساب إلّا بإنشاء مسؤول. وهي مفاتيح منفصلة لأنّ إغلاق أحدها يعني عادةً تفضيل غيره: من يغلق التسجيل العامّ يريد في الغالب أن تصل الحسابات بالدعوة بدلًا منه. ولا يمسّ أيٌّ منها حسابًا قائمًا بالفعل.",
      allowSelfRegistration: "التسجيل العامّ",
      allowSelfRegistrationHint:
        "النقطة التي خلف نموذج التسجيل. كلّ طلبٍ يعبر يكلّف بصمة كلمة مرور وصفًّا في قاعدة البيانات ورسالةً تُرسل إلى أيّ عنوانٍ كُتب، فالخادم الذي لا يريد تسجيلًا عامًّا ينبغي أن يرفض قبل أن يدفع شيئًا من ذلك. وعند الإغلاق يكون الجواب واحدًا لكلّ عنوان، فلا تكشف النقطةُ من هو مسجَّل هنا. أمّا النموذج نفسه فلا يُخفى — لا شيء ينشر هذا الإعداد إلى صفحة التسجيل — فيملؤه الزائر ثمّ يُرفض عند الإرسال. والدعوات والحسابات التي ينشئها المسؤول لا تتأثّر.",
      allowExternalProvisioning: "التسجيل عبر Google أو Apple",
      allowExternalProvisioningHint:
        "هل يجوز لهويّة مزوّدٍ لا تطابق أيّ حساب هنا أن تُنشئ حسابًا عند أوّل دخول. هذا تسجيلٌ ذاتيّ بطريقٍ آخر، ويبقى مفتوحًا مع إغلاق المفتاح أعلاه ما لم تُغلقه أنت أيضًا. الحسابات القائمة تواصل الدخول في الحالتين، ويظلّ ربط المزوّد بحسابٍ يحمل العنوان نفسه ممكنًا.",
      allowInvitationRegistration: "التسجيل عبر دعوة",
      allowInvitationRegistrationHint:
        "هل يجوز أن يُنشئ استخدامُ دعوة مؤسّسةٍ حسابًا جديدًا. إغلاق التسجيل العلنيّ يعني عادةً أن تصل الحسابات بالدعوة بدلًا منه، فجُعل هذا مفتاحًا مستقلًّا؛ وبإغلاق الثلاثة لا يوجد حساب إلّا بإنشاء مسؤول. الدعوات المُرسَلة لا تُلغى، ومن يملك حسابًا يستطيع قبول الدعوة، لأنّ ذلك يضيف عضويّة ولا يُنشئ حسابًا.",
    },
    organizations: {
      title: "من يجوز له إنشاء مؤسّسة",
      description:
    ...
    email: {
      ...
      groups: {
        server: "خادم البريد",
        sender: "المرسِل والروابط",
        codes: "الرموز وحدود الإرسال",
        codesDescription:
          "هذه تحكم الرموز والروابط نفسها، لا الاتصال بالخادم.",
      },
      smtpHost: "خادم SMTP",
    ...
    imageStorage: {
      ...
      groups: {
        location: "التخزين والنشر",
        limits: "ما يُقبل من الملفات المرفوعة",
      },
      ...
      maxMegapixelsHint:
        "يرفض قنابل فك الضغط قبل المعالجة. الموصى به: 24 — فكل ميغابكسل يُقبَل يكلّف 4 ميغابايت من الذاكرة أثناء فكّ ترميز الصورة، ويعمل هذا الحدّ مع حدّ تزامن الرفع.",
    ...
    accountDeletionSection: {
      ...
      groups: {
        request: "ما يراه صاحب الحساب المحذوف",
        execution: "كيف يُنفَّذ الحذف",
      },
    ...
    dataController: {
      ...
      groups: {
        identity: "من هو المتحكّم بالبيانات",
        processors: "من يعالج البيانات نيابةً عنه",
        registrations: "التسجيلات التركية",
        registrationsDescription:
          "كلاهما اختياري. لا تملأهما إلا حيث يكون المتحكّم مسجَّلًا في تركيا.",
      },
    ...
    expiredDataCleanup: {
      ...
      groups: {
        sweeper: "كيف يعمل التنظيف",
        retention: "مدة بقاء السجلات الميتة",
        retentionDescription:
          "كل صفٍّ تحكمه هذه الإعدادات منتهي الصلاحية أصلًا. والسؤال هو كم يبقى صالحًا كدليل على أنّ شيئًا قد حدث.",
      },
      ...
      pendingRegistrationDays: "طلبات التسجيل المعلّقة (أيام)",
      pendingRegistrationDaysHint:
        "محاولات إنشاء حسابٍ انتهى رمزها، اكتملت أو لم تكتمل. تُحفظ دليلًا على من حاول التسجيل وبأيّ عنوان. الموصى به: 7.",
    },
    dataRetention: {
  ...
  validation: {
    ...
    minLength: "يجب ألا يقل عن {{count}} من الأحرف.",
