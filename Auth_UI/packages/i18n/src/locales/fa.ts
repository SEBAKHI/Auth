...
export const fa: TranslationResources = {
  ...
  settingsSearch: {
    ...
    hint: "یک تنظیم را با نام یا با کلید پیکربندی آن پیدا کنید.",
    pages: "صفحه‌ها",
    recent: "اخیر",
    ...
    noResultsFor: "هیچ تنظیمی با «{{query}}» مطابقت ندارد",
    emptySuggestion: "کلمات کمتری را امتحان کنید، یا کلید پیکربندی تنظیم را بنویسید.",
