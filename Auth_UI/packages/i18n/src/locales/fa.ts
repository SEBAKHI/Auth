...
export const fa: TranslationResources = {
  ...
  systemSettings: {
    ...
    password: {
      ...
      expirationDays: "انقضای رمز عبور (روز)",
      expirationDaysHint:
        "پس از این تعداد روز، تغییر رمز عبور اجباری می‌شود. پیشنهاد: ۰ (خاموش) — NIST انقضای دوره‌ای را توصیه نمی‌کند؛ در عوض به بررسی رمزهای لورفته تکیه کنید.",
