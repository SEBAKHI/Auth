  ...
  systemSettings: {
    ...
    session: {
      ...
      terminateSessionsOnPasswordResetHint:
        "وقتی رمز عبور از طریق پیوند ایمیل بازنشانی می‌شود، همه نشست‌های موجود بسته می‌شوند. پیشنهاد: روشن — بازنشانی اغلب پس از احتمال نفوذ انجام می‌شود. نشست ورود یکپارچه همیشه پایان می‌یابد، حتی اگر این گزینه خاموش باشد.",
    },
    gateway: {
      title: "محافظت درگاه",
      description:
