...
export const fa: TranslationResources = {
  ...
  systemSettings: {
    ...
    session: {
      ...
      terminateSessionsOnPasswordReset: "خروج از همه‌جا هنگام بازنشانی رمز عبور",
    ...
    notificationsSection: {
      ...
      newDeviceAlertEnabledHint: "نخستین باری که ورودی از دستگاهی ناشناخته می‌رسد، به صاحب حساب ایمیل می‌فرستد. پیشنهاد: روشن.",
      newDeviceAlertMinIntervalMinutes: "کمترین فاصله میان هشدارها (دقیقه)",
      newDeviceAlertMinIntervalMinutesHint: "مانع می‌شود رگباری از ورودها به رگباری از ایمیل‌ها تبدیل شود. مقدار ۰ برای هر دستگاه جدید یکی می‌فرستد. پیشنهاد: ۶۰.",
    ...
    geoIp: {
      ...
      description: "نشانی‌های IP ورود را به کشور و شهر تبدیل می‌کند تا تاریخچه ورود و هشدارهای دستگاه جدید بتوانند بگویند تلاش از کجا آمده است. به یک فایل پایگاه‌داده محلی MaxMind نیاز دارد؛ بدون آن این قابلیت خاموش می‌ماند و مکان‌ها نامشخص نمایش داده می‌شوند.",
      enabled: "فعال‌سازی مکان‌یابی جغرافیایی IP",
      enabledHint: "به یک فایل پایگاه‌داده در مسیر زیر نیاز دارد. پس از راه‌اندازی مجدد اعمال می‌شود.",
      databasePath: "مسیر فایل پایگاه‌داده",
      databasePathHint: "مسیر مطلق فایل MaxMind GeoLite2 با پسوند ‎.mmdb روی سرور. پس از راه‌اندازی مجدد اعمال می‌شود.",
    },
    imageStorage: {
    ...
    expiredDataCleanup: {
      ...
      description: "ردیف‌هایی که دیگر استفاده نمی‌شوند چه مدت نگه داشته می‌شوند پیش از آنکه پاک‌سازی روزانه آن‌ها را حذف کند. این‌ها مدت اعتبار نیستند — هر ردیف اینجا از پیش مرده است. این‌ها تعیین می‌کنند چه مدت به‌عنوان مدرک کارآمد می‌ماند: توکن تازه‌سازی باطل‌شده همان چیزی است که توکن دزدیده‌شده را به سرقتی کشف‌شده بدل می‌کند، و کد مجوز مصرف‌شده همان چیزی است که تکرار را ثابت می‌کند.",
      enabled: "اجرای پاک‌سازی روزانه",
      enabledHint: "در حالت خاموش هیچ جدولی دست نمی‌خورد و همه بی‌حد رشد می‌کنند. پیشنهاد: روشن.",
      workerPollMinutes: "فاصله بررسی (دقیقه)",
      workerPollMinutesHint: "سرویس هر چند وقت بررسی می‌کند که پاک‌سازی امروز انجام شده یا نه. خود پاک‌سازی روزی یک بار اجرا می‌شود. پیشنهاد: ۱۵.",
      batchSize: "ردیف در هر دستور",
      batchSizeHint: "زیر آستانه حدود ۵۰۰۰ قفل ردیف نگه داشته می‌شود که در آن SQL Server کل جدول را قفل می‌کند و هر پرس‌وجوی زنده روی آن مسدود می‌شود. پیشنهاد: ۴۰۰۰.",
      maxRowsPerTablePerRun: "سقف هر جدول در هر اجرا",
      maxRowsPerTablePerRunHint: "اجرای نخست را محدود می‌کند؛ تنها اجرایی که با همه انباشته‌های پس از استقرار روبه‌روست. باقی‌مانده روز بعد. پیشنهاد: ۲۰۰۰۰۰.",
      authorizationCodeDays: "کدهای مجوز (روز)",
      authorizationCodeDaysHint: "حدود ۶۰ ثانیه زنده‌اند؛ این بازه برای بررسی تکرار است، نه برای معتبر نگه داشتن آن‌ها. پیشنهاد: ۷.",
      ...
      idpSessionDaysHint: "از انقضا یا ابطال شمرده می‌شود، نه از ایجاد. پیشنهاد: ۳۰.",
      refreshTokenDays: "توکن‌های تازه‌سازی (روز)",
      refreshTokenDaysHint: "بلندترین و مهم‌ترین بازه: ردیف باطل‌شده تنها چیزی است که توکن دزدیده‌شده را به سرقتی کشف‌شده بدل می‌کند، و داشبورد ابطال‌ها را تا ۹۰ روز گزارش می‌دهد. هر مقداری که اینجا تنظیم شود، در کد کف ۹۰ روز اعمال می‌شود.",
    },
    dataRetention: {
  ...
  profile: {
    ...
    unattributedHelp: "نشست‌هایی که هیچ مرورگری را مشخص نکردند، مانند برنامه‌های متصل.",
    ...
    unrecognisedActivity: "چیزی را اینجا نمی‌شناسید؟ گذرواژه‌تان را تغییر دهید.",
