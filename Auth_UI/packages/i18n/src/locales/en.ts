...
export const en = {
  ...
  auth: {
    ...
    passwordRuleDigit: "At least one number (0–9)",
    passwordRuleSpecial: "At least one symbol, such as ! @ # $ %",
    passwordRuleMet: "Met",
    passwordRuleUnmet: "Not met yet",
    passwordRulesProgress: "{{met}} of {{total}} password requirements met",
