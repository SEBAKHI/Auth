...
export const fr: TranslationResources = {
  ...
  settingsSearch: {
    ...
    hint: "Trouvez un paramètre par son nom ou par sa clé de configuration.",
    pages: "Pages",
    recent: "Récents",
    ...
    noResultsFor: "Aucun paramètre ne correspond à « {{query}} »",
    emptySuggestion:
      "Essayez moins de mots, ou la clé de configuration du paramètre.",
