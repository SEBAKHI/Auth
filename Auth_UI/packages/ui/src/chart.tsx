...
// Named imports, not `import * as RechartsPrimitive`: a namespace import keeps
// the whole of recharts reachable and defeats tree-shaking, and recharts is the
// single heaviest dependency in the console bundle.
