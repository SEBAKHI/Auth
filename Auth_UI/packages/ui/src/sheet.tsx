...
/**
 * Width scale for the side sheets, mirroring the dialog one so both surfaces are
 * sized by intent instead of a per-call-site `sm:max-w-*`. Only the left/right
 * sides take a width; top/bottom sheets are full-bleed by design.
 */
const sheetContentVariants = cva(
  "fixed z-50 flex flex-col overflow-x-hidden bg-popover bg-clip-padding text-sm text-popover-foreground shadow-xl transition duration-200 ease-in-out data-[side=bottom]:inset-x-0 data-[side=bottom]:bottom-0 data-[side=bottom]:h-auto data-[side=bottom]:border-t data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:w-full data-[side=left]:border-e data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:w-full data-[side=right]:border-s data-[side=top]:inset-x-0 data-[side=top]:top-0 data-[side=top]:h-auto data-[side=top]:border-b data-open:animate-in data-open:fade-in-0 data-[side=bottom]:data-open:slide-in-from-bottom-10 data-[side=left]:data-open:slide-in-from-left-10 data-[side=right]:data-open:slide-in-from-right-10 data-[side=top]:data-open:slide-in-from-top-10 data-closed:animate-out data-closed:fade-out-0 data-[side=bottom]:data-closed:slide-out-to-bottom-10 data-[side=left]:data-closed:slide-out-to-left-10 data-[side=right]:data-closed:slide-out-to-right-10 data-[side=top]:data-closed:slide-out-to-top-10",
  {
    variants: {
      size: {
        sm: "data-[side=left]:sm:max-w-sm data-[side=right]:sm:max-w-sm",
        /** Default: a record's detail fields. */
        md: "data-[side=left]:sm:max-w-md data-[side=right]:sm:max-w-md",
        lg: "data-[side=left]:sm:max-w-lg data-[side=right]:sm:max-w-lg",
        /** Rendered previews, message bodies, anything with wide content. */
        xl: "data-[side=left]:sm:max-w-2xl data-[side=right]:sm:max-w-2xl",
        "2xl": "data-[side=left]:sm:max-w-4xl data-[side=right]:sm:max-w-4xl",
      },
    },
    defaultVariants: {
      size: "md",
